...
?>
        <script>
            Swal.fire({
                ...
                text: "Este vehiculo tiene inspecciones pendientes en cabina pintura,desea inspeccionarlo?",
                showConfirmButton: true,
                showCancelButton: true,
            }).then((resultado) => {
                if (resultado.isConfirmed) {
                    url = "/Inspecciones/views/cabina_pintura/inspeccion.php?id_vehiculo=<?php echo $id_vehiculo ?>&id_modelo=<?php echo $id_modelo ?>&estacion=<?php echo $estacion ?>";
                    location.href = url;
