...
width: 100%;">
    ...
    <form action="/Inspecciones/controller/registrar/insertarDetalleVehiculo.php?id_vehiculo=<?php echo $id_vehiculo ?>&id_estacion=<?php echo $estacion ?>&formato=<?php echo $formato ?>&id_modelo=<?php echo $formato ?>" id="registro" method="POST">
