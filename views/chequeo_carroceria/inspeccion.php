...
?>
    ...
    <h5 class="text-center " style="margin-top:2%; color: var(--dark); ">C: Conforme NC: no conforme </h5>
...
width: 100%;">
        <div style="margin: 1% auto;" class="form-group">
            ...
            <div class="col text-center ">
                <button type="submit" onclick="marcarAprobado()" id="rellenar" name="rellenar" class="btn btn-success">Colocar conforme todas las inspecciones</button>
            </div>
        </div>
        ...
        <div style="margin: 1% auto;" class="form-group">
            <label class="col-md-4 control-label" for="rellenar"></label>
            <div class="col text-center ">
                <button type="submit" onclick="marcarReprobado()" id="rellenar2" name="rellenar2" class="btn btn-danger">Colocar no conforme todas las inspecciones</button>
            </div>
        </div>
    ...
    <form action="/Inspecciones/controller/registrar/insertarChequeoCarroceria.php?id_vehiculo=<?php echo $id_vehiculo ?>&id_estacion=<?php echo $estacion ?>&formato=<?php echo $formato ?>&id_modelo=<?php echo $formato ?>" method="POST">
        <div class="container" style="display: flex; flex-wrap: wrap; width: 100%;">
            <?php foreach ($inspecciones as $inspeccion) : ?>

                <div class="card-wrapper" style="width: 45%; margin: 2% 2%;">
                    <div class="card">
                        <div class="card-body" style="display: flex; flex-direction: column; padding: 1rem;">
                            ...
                            <div class="form-group row" style="display: flex; flex-direction: row; align-items: center;">
                                <label class="col-4" style="flex-grow: 0; font-size: 0.8rem;">Ensamblaje (E)</label>
                                <div class="col-8 d-flex justify-content-between" style="flex-grow: 1;">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input onclick="handleRadioClick(this)" name="e[<?php echo $inspeccion->id; ?>]" id="e<?php echo $inspeccion->id ?>" type="radio" class="form-check-input" value="Conforme">
                                        <label for="e<?php echo $inspeccion->id ?>" class="form-check-label" style="font-size: 0.8rem;">C</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input onclick="handleRadioClick(this)" name="e[<?php echo $inspeccion->id; ?>]" id="e<?php echo $inspeccion->id ?>" type="radio" class="form-check-input" value="No Conforme">
                                        <label for="e<?php echo $inspeccion->id ?>" class="form-check-label" style="font-size: 0.8rem;">NC</label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row" style="display: flex; flex-direction: row; align-items: center;">
                                <label class="col-4" style="flex-grow: 0; font-size: 0.8rem;">Apariencia (AP)</label>
                                <div class="col-8 d-flex justify-content-between" style="flex-grow: 1;">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input name="ap[<?php echo $inspeccion->id; ?>]" id="ap<?php echo $inspeccion->id ?>" type="radio" class="form-check-input" value="Conforme">
                                        <label for="ap<?php echo $inspeccion->id ?>" class="form-check-label" style="font-size: 0.8rem;">C</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input name="ap[<?php echo $inspeccion->id; ?>]" id="ap<?php echo $inspeccion->id ?>" type="radio" class="form-check-input" value="No Conforme">
                                        <label for="ap<?php echo $inspeccion->id ?>" class="form-check-label" style="font-size: 0.8rem;">NC</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" style="display: flex; flex-direction: row; align-items: center;">
                                <label class="col-4" style="flex-grow: 0; font-size: 0.8rem;">Fijacion (AP)</label>
                                <div class="col-8 d-flex justify-content-between" style="flex-grow: 1;">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input name="f[<?php echo $inspeccion->id; ?>]" id="f<?php echo $inspeccion->id ?>" type="radio" class="form-check-input" value="Conforme">
                                        <label for="f<?php echo $inspeccion->id ?>" class="form-check-label" style="font-size: 0.8rem;">C</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input name="f[<?php echo $inspeccion->id; ?>]" id="f<?php echo $inspeccion->id ?>" type="radio" class="form-check-input" value="No Conforme">
                                        <label for="f<?php echo $inspeccion->id ?>" class="form-check-label" style="font-size: 0.8rem;">NC</label>
                                    </div>
                                </div>
                            </div>
